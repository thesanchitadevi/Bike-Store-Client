  ...
  return (
    <div>
      <div className="grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6">
          ...
          <div className="space-y-8 mt-8">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs mt-1 text-gray-500">Monday to Friday.</p>
        ...
        <div className="bg-gray-100 rounded-3xl md:col-span-2 p-8">
          ...
          <form>
            <div className="space-y-4 mt-8">
              <input
                ...
                className="px-2 py-3 bg-transparent text-gray-800 font-medium w-full text-sm border-b border-gray-400 focus:border-red-300 outline-none"
              />
              ...
              <textarea
                ...
                className="px-2 pt-3 bg-transparent text-gray-800 font-medium w-full text-sm border-b border-gray-400 focus:border-red-300 outline-none"
              ></textarea>
            </div>

            <button
              type="button"
              className="mt-8 flex items-center justify-center text-sm rounded-md px-4 py-2.5 text-gray-800 bg-red-400 hover:bg-red-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
